...
var __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/timetable.json.[json].js [app-client] (ecmascript)");
;
...
function HomePage() {
    _s();
    const schedule = __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].schedule;
    const degreesMeta = __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].degrees;
    ...
    const filteredSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HomePage.useMemo[filteredSchedule]": ()=>{
            return schedule.filter({
                ...
                "HomePage.useMemo[filteredSchedule]": (a, b)=>{
            ...
            DAYS.forEach({
                "HomePage.useMemo[weeklyDayCounts]": (d)=>{
                    counts[d] = schedule.filter({
                        "HomePage.useMemo[weeklyDayCounts]": (s)=>s.course_code !== "GENERIC" && s.course_title && s.course_title !== s.section_code && s.degree_code === selectedDegree && (!selectedBatch || s.batch === selectedBatch || s.batch === "All") && (!selectedSection || s.section_code === selectedSection || s.section_code === "ALL") && s.day.toLowerCase() === d.toLowerCase()
...
"[project]/timetable.json.[json].js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=_1w1z8bz._.js.map