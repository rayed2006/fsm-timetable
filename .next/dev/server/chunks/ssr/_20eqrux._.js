...
var __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/timetable.json.[json].js [app-ssr] (ecmascript)");
"use client";
;
;
;
 ...
 */ function getMinutesFromTime(timeStr) {
    ...
    if (hour >= 1 && hour <= 7) {
        hour += 12; // PM afternoon slots (01:00 -> 13:00, 02:25 -> 14:25, etc.)
    }
    return hour * 60 + (isNaN(minute) ? 0 : minute);
}
function HomePage() {
    const schedule = __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].schedule;
    const degreesMeta = __TURBOPACK__imported__module__$5b$project$5d2f$timetable$2e$json$2e5b$json$5d2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].degrees;
    ...
    const filteredSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return schedule.filter((item)=>{
            // Exclude generic / blank / self-referencing titles
    ...
    const weeklyDayCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const counts = {};
        DAYS.forEach((d)=>{
            counts[d] = schedule.filter((s)=>s.course_code !== "GENERIC" && s.course_title && s.course_title !== s.section_code && s.degree_code === selectedDegree && (!selectedBatch || s.batch === selectedBatch || s.batch === "All") && (!selectedSection || s.section_code === selectedSection || s.section_code === "ALL") && s.day.toLowerCase() === d.toLowerCase()).length;
        });
        return counts;
    }, [
        schedule,
...
"[project]/timetable.json.[json].js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

throw new Error("Unable to make a module from invalid JSON: EOF while parsing a value at line 11975 column 6");
}),
];

//# sourceMappingURL=_20eqrux._.js.map